    ...
    <div :class="['side-cart d-flex flex-column justify-content-between', {'active': isActive}]">
        <div class="top">
            <div class="content d-flex justify-content-between align-items-center">
                <h6 class="text-uppercase">Ваша Корзина ({{ quantityOfCartProducts }})</h6>
                <span
                    ...
                    <div class="items d-flex justify-content-between align-items-center">
                        <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                            ...
                            <div class="text">
                                ...
                                <p>{{ product.quantity }} X <span>${{ transformToTwoDecimalPlaces(product.price) }}</span></p>
                            </div>
                        </div>
                        <div class="right">
        ...
        <div class="bottom">
            <div class="total-ammount d-flex justify-content-between align-items-center">
                <h6 class="text-uppercase">Итог:</h6>
            ...
            <div class="button-box d-flex justify-content-between">
                <router-link
                    class="btn_black"
                    :to="{name: 'cart'}"
                >Посмотреть корзину</router-link>
                <a href="cart.html" class="button-2 btn_theme"> Оформить </a></div>
        </div>
    </div>
</template>
